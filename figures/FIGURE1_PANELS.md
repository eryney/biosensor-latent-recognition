...
| PDB  | State  | Y65-F391 cleft (Cα) | Ligand      |
|------|--------|---------------------|-------------|
| 7S7V | open   | 17.7 Å              | —           |
...
for the docking panel. 7S7U and 7S7T differ by 0.5 Å across this measure; 7S7U was
selected as the nicotine-bound structure of the sensor from which this family
descends.
...
`panels/panel_b_mechanism.png`

Schematic of the conformational change that couples ligand binding to fluorescence
output. Not derived from data.
...
`cage_Y460`) with labels pre-placed at each Cβ.
